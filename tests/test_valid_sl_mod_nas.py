"""
Test valid SL modification on NAS100 respecting broker stops_level
"""
...
def main():
    ...
    sl_initial = round(entry_price - 40.0, digits)
    tp_initial = round(entry_price + 40.0, digits)
    ...
    # 2. Modify SL: 15.0 pts below current bid (min required is 7.0 pts)
    cur_tick = mt5.symbol_info_tick(symbol)
    new_sl = round(cur_tick.bid - 15.0, digits)
